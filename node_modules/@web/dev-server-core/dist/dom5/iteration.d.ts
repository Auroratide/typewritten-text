 ...
 * list of results.
 */
export declare function treeMap<U>(node: any, mapfn: (node: any) => Iterable<U>, getChildNodes?: GetChildNodes): IterableIterator<U>;
/**
 * Yields `node` and all of its children, recursively.
 *
 * Yields `node` first, then yields each descendent in depth first order.
 */
export declare function depthFirst(node: any, getChildNodes?: GetChildNodes): IterableIterator<Node>;
/**
 ...
 */
export declare function depthFirstReversed(node: any, getChildNodes?: GetChildNodes): IterableIterator<Node>;
/**
 * Yields `node` and each of its ancestors leading up the tree.
 */
export declare function ancestors(node: any): IterableIterator<Node>;
/**
 ...
 * closest to `node`)
 */
export declare function previousSiblings(node: any): IterableIterator<Node>;
/**
 ...
 */
export declare function prior(node: any): IterableIterator<Node>;
/**
 ...
 * predicate.
 */
export declare function queryAll(node: any, predicate: Predicate, getChildNodes?: GetChildNodes): Generator<Node, void, unknown>;
